...
1. **Pinning Apps**: 
   ...
   ![Right-click an app and select Pin to Start](assets/ch3/3.1-A-1.jpg)
   *Figure 1: Right-clicking an app in the All apps list to pin it.*

   ![App successfully pinned to Start](assets/ch3/3.1-A-2.jpg)
...
2. **Organizing with Folders**:
   ...
   ![Two apps being merged into a folder, and the folder naming interface](assets/ch3/3.1-B.jpg)
...
3. **Adjusting the Layout**:
   ...
   ![The Start settings page showing the three layout options](assets/ch3/3.1-C.jpg)
...
1. **Taskbar Alignment**:
   ...
   ![Taskbar settings window with the "Taskbar behaviors" section expanded and alignment dropdown visible](assets/ch3/3.2-A.jpg)
...
2. **Managing System Icons**:
   ...
   ![The "Taskbar items" section in Settings with various icons toggled on/off](assets/ch3/3.2-B.jpg)
...
1. **Accessing Quick Settings**: 
   ...
   ![The Quick Settings panel open in the bottom-right corner](assets/ch3/3.3-A.jpg)
...
2. **Editing the Panel**:
   ...
   ![Quick Settings in edit mode, showing "Unpin" icons and the "Add" button](assets/ch3/3.3-B.jpg)
...
1. **Checking Notifications**:
   ...
   ![Notification Center open above the calendar flyout](assets/ch3/3.4-A.jpg)
...
2. **Enabling Do Not Disturb**:
   ...
   ![Notification settings page with Do Not Disturb turned on](assets/ch3/3.4-B.jpg)
...
1. **The Emoji Picker**:
   ...
   ![The Emoji panel open with the "Symbols" tab selected](assets/ch3/3.5-A.jpg)
...
2. **Voice Typing**:
   ...
   ![The small voice typing toolbar active on screen](assets/ch3/3.5-B.jpg)
...
1. **Using Snap Layouts**:
   ...
   ![Mouse hovering over the maximize button, revealing the Snap Layouts flyout](assets/ch3/3.6-A.jpg)
...
3. **Snap Groups**:
   ...
   ![Taskbar preview showing a "Group" of windows](assets/ch3/3.6-B.jpg)
...
1. **Creating a New Desktop**:
   ...
   ![Task View screen with the "New desktop" button clearly visible](assets/ch3/3.7-A.jpg)

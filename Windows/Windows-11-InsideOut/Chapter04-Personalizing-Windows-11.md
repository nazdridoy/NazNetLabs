...
2. **Choosing a Background Type**:
   ...
   <figure>
    <img src="assets/ch4/4.1-A.webp" alt="Personalize your background options" >
    <figcaption align="left"><i>Figure 1: The Background settings page showing the personalization dropdown.</i></figcaption>
   </figure>
...
3. **Picking your image**:
   ...
   <figure>
    <img src="assets/ch4/4.1-B.webp" alt="Choose a fit for your desktop image" >
    <figcaption align="left"><i>Figure 2: The "Choose a fit" dropdown menu visible in Background settings.</i></figcaption>
   </figure>
...
2. **Adding App Status**:
   ...
   <figure>
    <img src="assets/ch4/4.2-A.webp" alt="Lock screen settings page showing the status app selection menu" >
    <figcaption align="left"><i>Figure 1: Lock screen settings page showing the status app selection menu.</i></figcaption>
   </figure>
...
2. **Changing Pointer Style**:
   ...
   <figure>
    <img src="assets/ch4/4.3-A.webp" alt="Mouse pointer style selection area with the custom color palette visible" >
    <figcaption align="left"><i>Figure 1: The mouse pointer style selection area with the custom color palette visible.</i></figcaption>
   </figure>
...
3. **Adjusting Size**:
   ...
   <figure>
    <img src="assets/ch4/4.3-B.webp" alt="The pointer size slider being adjusted" >
    <figcaption align="left"><i>Figure 1: The pointer size slider being adjusted.</i></figcaption>
   </figure>
...
1. **Adjusting Date and Time**:
   ...
   <figure>
    <img src="assets/ch4/4.4-A.webp" alt="Date & time settings page with &quot;Set time automatically&quot; and Time zone dropdown" >
    <figcaption align="left"><i>Figure 1: Date & time settings page with "Set time automatically" and Time zone dropdown.</i></figcaption>
   </figure>
...
2. **Language and Region**:
   ...
   <figure>
    <img src="assets/ch4/4.4-B.webp" alt="Language & region page showing the regional format settings" >
    <figcaption align="left"><i>Figure 1: Language & region page showing the regional format settings.</i></figcaption>
   </figure>
...
2. **Enabling Icons**:
   ...
   <figure>
    <img src="assets/ch4/4.5-A.webp" alt="The small &quot;Desktop Icon Settings&quot; dialog box with varios checkboxes checked" >
    <figcaption align="left"><i>Figure 1: The small "Desktop Icon Settings" dialog box with varios checkboxes checked.</i></figcaption>
   </figure>
...
2. **Installing New Fonts**:
   ...
   <figure>
    <img src="assets/ch4/4.6-A.webp" alt="The Fonts settings page showing the drag-and-drop installation area" >
    <figcaption align="left"><i>Figure 1: The Fonts settings page showing the drag-and-drop installation area.</i></figcaption>
   </figure>
...
2. **Syncing Folders**:
   ...
   <figure>
    <img src="assets/ch4/4.7-A.webp" alt="The Windows Backup page showing the OneDrive sync options" >
    <figcaption align="left"><i>Figure 1: The Windows Backup page showing the OneDrive sync options.</i></figcaption>
   </figure>

...
2. **Choosing Your Source**:
   ...
   <figure>
    <img src="assets/ch5/5.1-A.webp" alt="Advanced app settings" >
    <figcaption align="left"><i>Figure 1: The Advanced app settings page with the "Choose where to get apps" dropdown.</i></figcaption>
   </figure>
...
2. **Searching for an App**:
   ...
   <figure>
    <img src="assets/ch5/5.2-A.webp" alt="Microsoft Store search results" >
    <figcaption align="left"><i>Figure 2: Search results in the Microsoft Store.</i></figcaption>
   </figure>
...
3. **Installing**:
   ...
   <figure>
    <img src="assets/ch5/5.2-B.webp" alt="App installation page" >
    <figcaption align="left"><i>Figure 3: An app detail page showing the install button.</i></figcaption>
   </figure>
...
1. **The Settings Method**:
   ...
   <figure>
    <img src="assets/ch5/5.3-A.webp" alt="Uninstalling an app from Settings" >
    <figcaption align="left"><i>Figure 4: Uninstalling an app from the Installed apps list.</i></figcaption>
   </figure>
...
2. **Terminating a Process**:
   ...
   <figure>
    <img src="assets/ch5/5.4-A.webp" alt="Task Manager Processes tab" >
    <figcaption align="left"><i>Figure 5: Ending a task in Task Manager.</i></figcaption>
   </figure>
...
2. **Disabling an App**:
   ...
   <figure>
    <img src="assets/ch5/5.5-A.webp" alt="Task Manager Startup apps tab" >
    <figcaption align="left"><i>Figure 6: Disabling startup apps in Task Manager.</i></figcaption>
   </figure>
...
2. **Inspecting Entries**:
   ...
   <figure>
    <img src="assets/ch5/5.6-A.webp" alt="Autoruns tool interface" >
    <figcaption align="left"><i>Figure 7: Using the Autoruns tool to manage startup entries.</i></figcaption>
   </figure>
...
2. **Toggling Features**:
   ...
   <figure>
    <img src="assets/ch5/5.7-A.webp" alt="Windows Features dialog" >
    <figcaption align="left"><i>Figure 8: Enabling optional Windows features.</i></figcaption>
   </figure>
